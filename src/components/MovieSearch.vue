<template>
  <div>
    ...
    <div class="d-flex flex-column align-items-center" v-if="searchedMovies">
      <router-link :to="{ name: 'MovieDetail', params: {movie_id: searchedMovie.id }}" class="row mb-3 bg-light mx-0 rounded searched" v-for="searchedMovie in searchedMovies" :key="searchedMovie.id">
